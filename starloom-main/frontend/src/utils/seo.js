...
export const SEO_CONFIG = {
  // 首页
  home: {
    title: '天机命理_免费八字排盘_AI命理问答_塔罗牌占卜_周公解梦_姓名测试',
    description: '天机命理提供AI智能命理问答，基于百万案例大数据和资深大师经验。25款免费工具：八字排盘、塔罗牌占卜、周公解梦、姓名测试、生肖配对、星座配对、观音灵签、犯太岁查询、桃花运测试、财运测试等。',
    keywords: '天机命理,AI命理,八字排盘,塔罗牌占卜,周公解梦,姓名测试,生肖配对,星座配对,观音灵签,犯太岁,桃花运,财运测试,五行查询,宝宝起名,黄道吉日,免费算命,命理大师'
  },
  
  // 工具箱页面
  tools: {
    title: '免费命理工具箱_生肖配对_星座配对_姓名测试_周公解梦_天机命理',
    description: '天机命理工具箱提供25款免费命理测算工具：生肖配对、星座配对、姓名测试、周公解梦、塔罗牌占卜、观音灵签、犯太岁查询、桃花运测试、财运测试、五行查询、黄道吉日等，全部免费使用。',
    keywords: '命理工具,免费算命,生肖配对,星座配对,姓名测试,周公解梦,塔罗牌,观音灵签,犯太岁,桃花运,财运测试,五行查询,黄道吉日,在线测算'
  },
  ...
  // 天机问答（原AI问卦）
  divination: {
    title: '天机问答_塔罗牌占卜_观音灵签_天使数字_北欧符文_星座运势_天机命理',
    description: '天机问答提供中西方占卜服务：塔罗牌占卜、观音灵签、月老灵签、财神灵签、天使数字解读、北欧符文占卜、星座运势、生肖运势、今日运势、生命数字、生日密码等。基于百万命理案例，结合资深大师经验，为您指引方向。',
    keywords: '天机问答,塔罗牌占卜,观音灵签,月老灵签,财神灵签,天使数字,北欧符文,星座运势,生肖运势,今日运势,生命数字,生日密码,在线占卜,免费占卜,命理咨询,AI命理'
  },
  
  // 塔罗牌占卜
  tarot: {
    title: '塔罗牌占卜_在线塔罗牌_塔罗牌测试_爱情塔罗_天机命理',
    description: '免费在线塔罗牌占卜，抽取塔罗牌解读感情、事业、财运。78张韦特塔罗牌，专业塔罗牌解读，为您指引人生方向，解答内心困惑。',
    keywords: '塔罗牌,塔罗牌占卜,在线塔罗,塔罗牌测试,塔罗牌解读,爱情塔罗,韦特塔罗,塔罗牌含义,免费塔罗'
  },
  
  // 天使数字
  angelNumber: {
    title: '天使数字_天使数字含义_重复数字解读_111_222_333_天机命理',
    description: '免费天使数字解读，解析你看到的重复数字含义。111、222、333、444、555、666、777、888、999、1111、1212等天使数字，了解宇宙给你的神秘信息。',
    keywords: '天使数字,天使数字含义,重复数字,111含义,222含义,333含义,444含义,555含义,1111含义,数字命理,神秘数字'
  },
  
  // 北欧符文
  rune: {
    title: '北欧符文占卜_卢恩符文_符文解读_维京符文_天机命理',
    description: '免费北欧符文占卜，抽取卢恩符文解读命运。24个古老的维京符文，蕴含北欧神话的智慧，为您揭示人生的奥秘与指引。',
    keywords: '北欧符文,卢恩符文,符文占卜,维京符文,符文解读,Rune,古老占卜,北欧神话,符文含义'
  },
  
  // 生命数字
  numerology: {
    title: '生命数字_生命灵数_数字命理_1-9生命数字_天机命理',
    description: '免费生命数字测算，根据出生日期计算你的生命灵数。1-9九个生命数字，揭示你的性格特质、人生使命、天赋才能和命运走向。',
    keywords: '生命数字,生命灵数,数字命理,生日数字,命运数字,灵数学,数字占卜,性格分析'
  },
  
  // 生日密码
  birthdayCode: {
    title: '生日密码_366天生日性格_生日书_天机命理',
    description: '免费查询生日密码，366天每一天都有独特的性格密码。了解你的生日性格、优缺点、爱情观、事业运，发现专属于你的生日秘密。',
    keywords: '生日密码,生日性格,366天生日,生日书,生日分析,出生日期性格,生日占卜'
  },
  ...
  // 姓名配对
  nameMatch: {
    title: '姓名配对_名字配对测试_姓名缘分_天机命理',
    description: '免费姓名配对测试，输入双方名字测算缘分指数。分析姓名笔画、五行相生相克，看看你们的名字有多配。',
    keywords: '姓名配对,名字配对,姓名缘分,姓名测试,名字测试,情侣配对'
  },
  
  // 五行查询
  wuxing: {
    title: '五行查询_生辰八字五行_五行属性_天机命理',
    description: '免费五行查询，根据出生日期查询五行属性。分析五行强弱、喜用神、忌神，提供五行补救建议。',
    keywords: '五行查询,五行属性,生辰八字五行,喜用神,忌神,五行缺什么,五行补救'
  },
  
  // 观音灵签
  guanyin: {
    title: '观音灵签_在线求签_观音签解签_天机命理',
    description: '免费观音灵签在线求签，诚心祈祷抽取灵签。提供签诗解读、签文详解，为您指点迷津。',
    keywords: '观音灵签,观音签,在线求签,灵签解签,观音菩萨灵签,求签算命'
  },
