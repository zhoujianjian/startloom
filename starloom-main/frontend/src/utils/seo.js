...
export const SEO_CONFIG = {
  ...
  home: {
    ...
    description: '天机命理提供14款免费命理工具：八字排盘、周公解梦、姓名测试、生肖配对、星座配对、宝宝起名、公司起名、手机号测吉凶、车牌号测吉凶、缘分测试、黄道吉日查询等。资深命理师在线咨询。',
    keywords: '八字排盘,周公解梦,姓名测试,生肖配对,星座配对,宝宝起名,公司起名,手机号测吉凶,缘分测试,黄道吉日,万年历,今日运势,天机问答,免费算命,天机命理'
  },
