    ...
    <div class="chat-list" :class="screenWidth<=900 ? 'mb' : ''">
      <div class="answer">
            <div class="BotHeader">
              ...
              <div v-if="screenWidth<=900">天机喵</div>
            </div>
            <div class="record-content">
              <div class="allContent">
                <div class="fortune-content">
                  ...
                  <div class="top">
                      <div class="rightPart">
                          <div class="item" @click="changeTab(0)" :class="tab==0? 'active' : ''">基本特性</div>
                          <div class="item" @click="changeTab(1)" :class="tab==1? 'active' : ''">性格</div>
                          <div class="item" @click="changeTab(2)" :class="tab==2? 'active' : ''">爱情</div>
                          <div class="item" @click="changeTab(3)" :class="tab==3? 'active' : ''">事业</div>
                          <div class="item" @click="changeTab(4)" :class="tab==4? 'active' : ''">学业</div>
                          <div class="item" @click="changeTab(5)" :class="tab==5? 'active' : ''">健康</div>
                          <div class="item" @click="changeTab(6)" :class="tab==6? 'active' : ''">财富</div>
                          <div class="item" @click="changeTab(7)" :class="tab==7? 'active' : ''">桃花</div>
                      </div>
                  </div>
                  <div class="part1">
                      <!-- <div class="tittle">{{ presetData[1][tab].title }}</div>  -->
                      <div v-html="presetData[tab].content"></div>
                      <div v-for="(item, index) in presetData[tab].contents" :key="index">
